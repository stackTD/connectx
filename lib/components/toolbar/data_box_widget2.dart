...
class DataBoxWidget2 extends StatefulWidget {
  ...
  @override
  _DataBoxWidgetState2 createState() => _DataBoxWidgetState2();
}

class _DataBoxWidgetState2 extends State<DataBoxWidget2> {
  String currentAddress = '';
  late final ReactionDisposer _disposer;
  bool _isHovered = false;

  // State variables for user-selected ranges and colors
